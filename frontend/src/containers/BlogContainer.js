...
export class BlogContainer extends Component {
    render() {
        return (
            <div className="mt-20">
                <h1 className="text-white ml-5 text-4xl"> Machine Learning Blog </h1>
                <div className=" mt-5 py-24 bg-cover bg-center mx-5 border-gray-600 rounded-md border-solid border-2" style={blogHeaderStyle}>
                    <h2 className="text-white my-20 mx-40 text-2xl"> This area of my portfolio is dedicated to the various topics I
