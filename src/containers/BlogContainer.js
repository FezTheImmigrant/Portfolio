    ...
    render() {
        return (
            <div className="lg:pt-40 pt-32 min-h-screen">
                ...
                <h2 className="text-gray-400 sm:text-xl text-xs text-center lg:mx-64 md:mx-32 sm:mx-32 mx-10  fade-in-no-delay mb-10">
                    Welcome! This is where I discuss my thoughts on the world of Artificial Intelligence and Machine Learning.
                ...
                <div className="mx-auto">
                    <Query query={BLOG_QUERY}>
                        {({ data: { posts } }) => {
                            return <Blog posts={posts} dataType="blog" />;
                        }}
                    </Query>
                </div>
            </div>
